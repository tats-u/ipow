 ...
 * However, you can remove this notification only if you use this for
 * closed-source and non-commercial purpose such as competitive programming and
 * homework.
 *
...
#endif
{
  constexpr I I_0 = 0;
  static_assert(
    std::is_integral<I>::value == true,
    "冪指数は整数型でなければなりません。(The exponent must be an integer.)");
  T ret = (T)1;
